...
export const ThemeToggle = () => {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="w-9 h-9 p-2 rounded-full flex items-center justify-between bg-background-secondary hover:ring-1 hover:ring-accent-secondary gap-2"
    >
      {theme === "dark" ? (
        <svg
          width="800px"
    ...
    // <button
    //   onClick={toggleTheme}
    //   className="p-2 rounded bg-primary text-foreground"
    // >
